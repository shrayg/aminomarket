      ...
      <div className="mx-4 max-w-md animate-fade-in rounded-2xl bg-white p-8 shadow-2xl">
        ...
        <div className="mt-6 space-y-4">
          ...
          <label className="flex gap-3 text-sm">
            ...
            <span>
              ...
              only</strong> and are not for human or animal use. By continuing I
              agree to the{' '}
        ...
        <div className="mt-8 flex gap-4">
          <a
            ...
            className="flex-1 border border-ink-200 px-4 py-3 text-center font-medium text-ink-700 transition hover:bg-ink-50"
          >
            Exit
          </a>
          <button
            onClick={handleAgree}
            className="flex-1 bg-ink-900 px-4 py-3 font-medium text-white transition hover:bg-ink-800"
          >
            I Agree &amp; Enter
          </button>
        </div>
